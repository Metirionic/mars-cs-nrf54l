...
auto-detected from `zephyr/SDK_VERSION`, 1.0.1 for NCS v3.4.0) → and, with
...
| Zephyr SDK toolchain (ARM-only) | `~/zephyr-sdk-1.0.1/`, outside both | `west sdk install` |
...
bash ci/build.sh --target initiator \
  --preset nrf54l15dk_cent_a1_4,nrf54l15tag_cent_a2_4,ublox_cent_a1_4,ezurio_bl54l15u_cent_a2_4,fanstel_bm15c_cent_a1_4,minew_me54be01_cent_a1_4,raytac_an54lv_k15_cent_a3_4,insight_isp2454_cent_a1_4,ophelia4ev_cent_a1_4,kaga_ec4l15ba1_cent_a1_4,nrf54l15dk_cent_a1_4_ipt,nrf54l15tag_cent_a2_4_ipt,ublox_cent_a1_4_ipt,ezurio_bl54l15u_cent_a2_4_ipt,fanstel_bm15c_cent_a1_4_ipt,minew_me54be01_cent_a1_4_ipt,raytac_an54lv_k15_cent_a3_4_ipt,insight_isp2454_cent_a1_4_ipt,ophelia4ev_cent_a1_4_ipt,kaga_ec4l15ba1_cent_a1_4_ipt \
  --release-dir release
bash ci/build.sh --target reflector \
  --preset nrf54l15dk_peri_a1_4,nrf54l15tag_peri_a2_4,ezurio_bl54l15u_peri_a2_4,fanstel_bm15c_peri_a1_4,ublox_peri_a1_4,minew_me54be01_peri_a1_4,raytac_an54lv_k15_peri_a3_4,insight_isp2454_peri_a1_4,ophelia4ev_peri_a1_4,kaga_ec4l15ba1_peri_a1_4,nrf54l15dk_peri_a1_4_ipt,nrf54l15tag_peri_a2_4_ipt,ezurio_bl54l15u_peri_a2_4_ipt,fanstel_bm15c_peri_a1_4_ipt,ublox_peri_a1_4_ipt,minew_me54be01_peri_a1_4_ipt,raytac_an54lv_k15_peri_a3_4_ipt,insight_isp2454_peri_a1_4_ipt,ophelia4ev_peri_a1_4_ipt,kaga_ec4l15ba1_peri_a1_4_ipt \
  --release-dir release
```
...
docker run --rm -it --entrypoint /bin/bash -v "$PWD":/work -w /work \
  ghcr.io/nrfconnect/sdk-nrf-toolchain:v3.4.0 -lc '
...
- [west.yml](../west.yml) — pins NCS v3.4.0 (`nrf` / sdk-nrf @ v3.4.0, `import: true`).
- [nRF Connect SDK v3.4.0](https://developer.nordicsemi.com/nRF_Connect_SDK/)
  and Zephyr SDK 1.0.1.
