...
/** @brief LED used to indicate an active BLE connection. */
#define CON_STATUS_LED DK_LED1

/** @brief Semaphore signaled when a BLE connection is established. */
static K_SEM_DEFINE(sem_connected, 0, 1);
/** @brief Semaphore signaled when CS config creation completes. */
